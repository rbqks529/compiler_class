...
{
       0,     0,     3,     4,     7,     9,    12,    17,    21,    25,
      27,    31,    35,    39,    41,    43,    45
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      15,     0,    -1,    -1,    15,    16,    -1,     9,    -1,    17,
       9,    -1,     4,    10,    17,     9,    -1,    17,     5,    18,
      -1,    17,     6,    18,    -1,    18,    -1,    18,     7,    19,
      -1,    18,     8,    19,    -1,    18,    11,    19,    -1,    19,
      -1,     3,    -1,     4,    -1,    12,    17,    13,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    50,    50,    52,    56,    57,    58,    66,    67,    68,
      72,    73,    77,    81,    85,    86,    87
};
#endif
...
#line 58 "parser.y"
    {
          setvar((yyvsp[(1) - (4)].id), (yyvsp[(3) - (4)].num));
...
#line 73 "parser.y"
    {
          if ((yyvsp[(3) - (3)].num) == 0) { fprintf(stderr, "division by zero\n"); (yyval.num) = 0.0; }
...
#line 77 "parser.y"
    {
          if ((yyvsp[(3) - (3)].num) == 0) { fprintf(stderr, "modulo by zero\n"); (yyval.num) = 0.0; }
          else (yyval.num) = (int)(yyvsp[(1) - (3)].num) % (int)(yyvsp[(3) - (3)].num);
      ;}
    break;
...
#line 85 "parser.y"
  ...
  case 15:
#line 86 "parser.y"
    { (yyval.num) = getvar((yyvsp[(1) - (1)].id)); free((yyvsp[(1) - (1)].id)); ;}
    break;
